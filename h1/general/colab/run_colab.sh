...
#      !bash h1/general/colab/run_colab.sh <PKG_ALIAS> [N_TRIALS] [RESUME_DATE]
#
#  Examples:
...
if [[ -z "$PKG_ALIAS" ]]; then
    ...
    echo "Aliases: ql|bayesian|1, dql|2, dqn|3, ac|a2c|4, rdqn|recurrent|6, transformer|tr|5, ens_sprb|ens_accq"
    exit 1
fi
...
case "$PKG_ALIAS" in
    ...
    ens_sprb|sprb)         PKG="pes_ens_sprb"; OPT_MODULE="ens.pes_ens_sprb.ext.optimize_ens" ;;
    ens_accq|accq)         PKG="pes_ens_accq"; OPT_MODULE="ens.pes_ens_accq.ext.optimize_ens" ;;
