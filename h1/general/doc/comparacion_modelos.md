...
[![Modelos](https://img.shields.io/badge/modelos-7-blue.svg)](#4-los-7-modelos-en-comparación)
...
> **Documento de tesis** — Evaluación comparativa de siete arquitecturas de
...
4. [Los 7 modelos en comparación](#4-los-7-modelos-en-comparación)
...
8. [Comparativa por categorías](#8-comparativa-por-categorías)
9. [Evolución del desempeño](#9-evolución-del-desempeño)
...
> regenerarse con
> `general/scripts/orchestrate` → `aggregate` → `plot_matrix` → `report` para
> el catálogo actual de 6 modelos; el reporte anterior incluía `pes_ens` y fue
> retirado junto con sus datos crudos.
...
## 4. Los 7 modelos en comparación
...
|------|--------|-----------|-----------------------------|----------|-------|-----|
| 1 | `pes_trf` | ML Transformer | **0,927180** | 0,045469 | 2026-05-02 | 64 |
| 2 | `pes_rdqn` | ML Recurrente | 0,898652 | 0,048764 | 2026-04-30 | 64 |
| 3 | `pes_dql` | Tabular | 0,896344 | 0,047708 | 2026-04-30 | 64 |
| 4 | `pes_dqn` | ML Denso | 0,893729 | 0,055170 | 2026-04-30 | 64 |
| 5 | `pes_a2c` | ML Actor-Crítico | 0,887236 | 0,063162 | 2026-04-30 | 64 |
| 6 | `pes_ql` | Tabular | 0,886640 | 0,060781 | 2026-04-30 | 64 |
| 7 | `pes_base` | Tabular | 0,801200 | 0,096000 | 2026-04-21 | 64 |

### 5.2 Ranking visual

$$
\underbrace{\texttt{trf}}_{0{,}9272}
...
La mejora del Transformer sobre los modelos tabulares y recurrentes es
estadísticamente significativa y de magnitud práctica relevante.
...
- **`pes_trf` logra la menor varianza** ($0{,}0455$) entre los modelos de
  un solo agente, indicando politicas consistentes y confiables.
...
5. **Atención causal:** la arquitectura Transformer captura dependencias
   de largo alcance que otros métodos no logran.
...
(optimización → arquitectura → mecanismo de memoria).
...
asignación de recursos en pandemia"* — se confirma como la mejor
arquitectura individual evaluada en el experimento.
...
2. **La hipótesis se confirma:** el Transformer es la mejor arquitectura
   evaluada, con desempeño superior en media y varianza.
3. **Recomendación metodológica:** la optimización bayesiana de
