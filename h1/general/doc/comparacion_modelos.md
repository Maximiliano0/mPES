...
> **Archivo histórico:** este documento fue generado cuando existía `pes_ens`.
> La línea h1 actual contiene siete paquetes implementados (seis en el
> benchmark); el ensemble eliminado y sus resultados no forman parte del
> estado actual.

**Evaluación comparativa de ocho arquitecturas de RL sobre el *Pandemic Scenario*.**

[![Modelos](https://img.shields.io/badge/modelos-8-blue.svg)](#4-los-8-modelos-en-comparación)
...
4. [Los 8 modelos en comparación](#4-los-8-modelos-en-comparación)
...
> 💡 Los heatmaps de robustez OOD deben regenerarse con
...
> Imagen no disponible: el paquete `pes_ens` y sus artefactos de salida fueron
> retirados del repositorio; esta sección se conserva solo como referencia
> narrativa histórica.
