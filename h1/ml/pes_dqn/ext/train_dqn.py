...
::
    ...
    python -m ml.pes_dqn.ext.train_dqn [num_episodes]
...
def main():
    ...
    ``config/CONFIG.py``.  Usage: ``python -m ml.pes_dqn.ext.train_dqn [episodes]``.
    """
