...
3. Train RDQN agent (default 175 000 episodes, configurable via CLI)
...
- RDQN-specific hyperparameters: hidden_units, batch_size, buffer_size,
  target_sync_freq
- Default episodes: 175 000 (configurable via CLI; see ``RDQN_EPISODES``)
...
def main():
    ...
    # RDQN hyperparameters — from CONFIG.py (Bayesian optimisation best trial #8, 2026-04-18)
    ...
    if best_info is not None:
        ...
        #     Optuna mean_perf).
        #   * Otherwise use the full training budget RDQN_EPISODES, NOT the
