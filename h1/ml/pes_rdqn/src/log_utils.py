"""
Logging Utilities for pes_rdqn (Pandemic Experiment Scenario — Recurrent Deep Q-Network)
...
def create_ConsoleLog_filehandle_singleton(SubjectId: str):
    ...
    SubjectId : str
        ...
        Format: PES_RDQN_log_{SubjectId}.txt
    ...
    Examples
    --------
    >>> handle = create_ConsoleLog_filehandle_singleton('2026-02-09_RDQN_AGENT')
    >>> # Creates: outputs/PES_RDQN_log_2026-02-09_RDQN_AGENT.txt
    """
    ...
    if ConsoleLog_filehandle is None:
        ...
        ConsoleLog_filehandle = open(ConsoleLog_filename, 'w', encoding='utf-8')
