"""
Package initialization module for the pes_base (Pandemic Experiment Scenario) project.
...
All configuration constants are re-exported at package level::
    ...
    from tabular.pes_base import AVAILABLE_RESOURCES_PER_SEQUENCE, PLAYER_TYPE, INPUTS_PATH
"""
######################
## External Imports ##
######################
