...
def provide_rdqn_agent_response(
    ...
    Notes
    -----
    - Requires RDQN model pre-training via: python3 -m pes_rdqn.ext.train_rdqn
    ...
    if not os.path.isfile(model_file):
        raise FileNotFoundError(
            ...
            f"Please train the RDQN-Agent first by running: python3 -m pes_rdqn.ext.train_rdqn\n"
        )
    ...
    try:
        ...
        raise RuntimeError(
            ...
            f"Error: {str(e)}\n"
            f"Files may be corrupted. Please retrain by running: python3 -m pes_rdqn.ext.train_rdqn\n"
        ) from e
