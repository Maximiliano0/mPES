...
::
    ...
    python -m pes_rdqn.ext.train_rdqn [num_episodes]
    ...
    #     ``python -m pes_rdqn.ext.optimize_rdqn``; falls back to the
...
def main():
    ...
    ``config/CONFIG.py``.  Usage: ``python -m pes_rdqn.ext.train_rdqn [episodes]``.
    """
