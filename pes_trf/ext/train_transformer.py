...
::
    ...
    python -m pes_trf.ext.train_transformer [num_episodes]
    ...
    #     ``python -m pes_trf.ext.optimize_tr``; falls back to the
...
def main():
    ...
    ``config/CONFIG.py``.  Usage: ``python -m pes_trf.ext.train_transformer [episodes]``.
    """
