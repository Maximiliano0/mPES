...
1. Materialising the scenario CSVs into ``general/<pkg>/scenarios/<sid>/``.
...
def _scenario_dir(pkg: str, scenario_id: str) -> str:
    return os.path.join(GENERAL_ROOT, pkg, 'scenarios', scenario_id)


def _scenario_outputs_dir(pkg: str, scenario_id: str) -> str:
    return os.path.join(GENERAL_ROOT, pkg, 'outputs', scenario_id)
