...
| `general/` | Cross-model OOD benchmark harness (22 scenarios × 6 models) | `scripts/orchestrate.py`, `scripts/aggregate.py`, `scripts/report.py` |

> The ensemble package (`ml/pes_ens`) has been **removed** from the project.
> Do not reintroduce references to it in new code or documentation.
