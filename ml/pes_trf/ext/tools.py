"""
pes_trf - Pandemic Experiment Scenario: Utility Functions

Small collection of helper functions used across pes_trf modules:
...
def convert_globalseq_to_seqs(sequence_map, seqin360):
    """Split a flat values array into per-sequence sub-arrays.
