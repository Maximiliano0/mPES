...
• Sequence Tools: Utilities for sampling, sequence length retrieval, and experiment control
...
def get_sequence_severity_from_allocations(Allocations, InitialSeverities):
    ...
    Allocations : array-like
        Resource allocation amounts for each trial in the sequence (0-10).
    ...
    -------
    float
        Sum of final severity values across all trials in the sequence.
    """
