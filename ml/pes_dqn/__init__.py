"""
Package initialization module for pes_dqn (Pandemic Experiment Scenario
with Deep Q-Network).

Variant of pes_ql that replaces the tabular Q-table with a neural-network
function approximator (DQN) featuring experience replay and a target
network.  This __init__ is structurally identical to pes_ql/__init__;
the DQN-specific behaviour lives in ext/dqn_model.py, ext/train_dqn.py,
and ext/optimize_dqn.py.
