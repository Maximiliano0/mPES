...
referencias can\'onicas son Sutton \& Barto~\citep{SuttonBarto2018} y,
para la programaci\'on din\'amica original, Bellman~\citep{Bellman1957}.
...
tipo \emph{warm restarts}~\citep{Loshchilov2017}. Para regularizar
la red se utiliza \emph{dropout}~\citep{Srivastava2014}.
...
Los m\'etodos de \emph{gradiente de pol\'itica}~\citep{Williams1992,Sutton2000}
...
prematuro de la pol\'itica~\citep{Mnih2016}. Variantes m\'as
estables como PPO~\citep{Schulman2017} introducen un objetivo
...
\emph{layer normalization}~\citep{Ba2016}, indispensable para
...
ofrecen una panor\'amica accesible del campo UQ. Existen alternativas
bayesianas aproximadas, como \emph{Monte~Carlo
Dropout}~\citep{Gal2016}, y frecuentistas, como los \emph{deep
ensembles}~\citep{Lakshminarayanan2017}, que tambi\'en producen
se\~nales de incertidumbre interpretables y motivan el paquete
\texttt{pes\_ens} de esta tesis.
