...
\def\biblio{\clearpage\bibliographystyle{unsrtnat}\bibliography{00_Main/References.bib}} % defines the \biblio command used for referencing in subfiles - DO NOT CHANGE
