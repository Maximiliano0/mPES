...
def _load_direct_best_params() -> dict | None:
    ...
    demand with ``python -m pes_a2c.ext.optimize_a2c --export-best``.
...
def main():
    ...
    if from_best_date is None:
        ...
        if _direct is not None:
            ...
            info("  regenerate with: python -m pes_a2c.ext.optimize_a2c --export-best")
            info("  override with:   python -m pes_a2c.ext.train_a2c --from-best YYYY-MM-DD")
            best_info = _direct
        else:
