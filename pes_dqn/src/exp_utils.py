"""
pes_dqn — Pandemic Experiment Scenario (Deep Q-Network)
...
def exit_experiment_gracefully(Message, Filehandles, MovementData, LogUtils, _PygameMediator):
    ...
    PygameMediator : module
        Pygame mediator module (currently unused for DQN-Agent mode)
    """
  ...
  # Tidy up remaining resources
    ...
    # PygameMediator.gracefully_quit_pygame()  # NOTE: Function not available for DQN-Agent mode
