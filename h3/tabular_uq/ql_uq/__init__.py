...
CONFIDENCE_ALLOCATION_PENALTY = CONFIG.CONFIDENCE_ALLOCATION_PENALTY
CONFIDENCE_RISK_FACTOR = CONFIG.CONFIDENCE_RISK_FACTOR
PENALTY_MODE = CONFIG.PENALTY_MODE
BOLTZMANN_EPSILON = CONFIG.BOLTZMANN_EPSILON
...
__all__ = [
    ...
    'SEVERITY_MULTIPLIER',
    'AGGREGATION_METHOD',
    'CONFIDENCE_ALLOCATION_PENALTY',
    'CONFIDENCE_RISK_FACTOR',
    'PENALTY_MODE',
    'BOLTZMANN_EPSILON',
]
